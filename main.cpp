...
{
	{
		...
		AssertEqual(ParseEvent(is), "event",
					"Parse event without leading spaces1");
	}
	{
		istringstream is("event big");
		AssertEqual(ParseEvent(is), "event big",
					"Parse event without leading spaces2");
	}
	{
		istringstream is("   sport event ");
		AssertEqual(ParseEvent(is), "sport event ",
					"Parse event with leading spaces3");
	}
	{
...
{
	{
		...
		AssertEqual(ParseDate(is), Date(2017, 11, 18), "ParseDate test#1");
	}
}
